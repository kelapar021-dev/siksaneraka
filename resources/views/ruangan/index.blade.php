...
<head>
    ...
    <title>Data Ruangan – SIAKAD</title>
...
<aside class="sidebar" id="sidebar">
    ...
    <a href="{{ route('ruangan.index') }}"  class="nav-link-sb active"><i class="bi bi-building"></i> Ruangan</a>
...
<div class="main-wrap">
    ...
    <div class="topbar">
        <div class="topbar-left">
            ...
            <div>
                <p class="topbar-title"><i class="bi bi-building me-1" style="color:var(--blue-600);"></i>Ruangan</p>
                <p class="topbar-sub">Kelola seluruh data ruangan kelas dan laboratorium</p>
            </div>
        </div>
    ...
    <div class="page-content">
        <div class="table-card">
            ...
            <div class="info-note">
                ...
                Sebagai <strong>Dosen</strong>, Anda dapat menambah ruangan baru. Edit dan hapus hanya untuk Admin.
            </div>
            @elseif($role == 'mahasiswa')
            <div class="info-note info-blue">
                <i class="bi bi-info-circle-fill"></i>
                Sebagai <strong>Mahasiswa</strong>, Anda hanya dapat melihat data ruangan.
            </div>
            @endif
            ...
            <div class="table-card-header" style="margin-top: {{ in_array($role, ['dosen', 'mahasiswa']) ? '0' : '16px' }};">
                <div class="d-flex align-items-center gap-3 flex-wrap">
                    <h5 class="table-card-title">
                        <i class="bi bi-building me-1" style="color:var(--blue-600);"></i>Data Ruangan
                    </h5>
                ...
                <div class="d-flex gap-2 align-items-center flex-wrap">
                    <input type="text" class="search-inp" id="searchInput" placeholder="🔍 Cari ruangan...">
                ...
                <table id="dataTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><span class="badge-kapasitas">{{ $item->kapasitas }} orang</span></td>
                            <td>{{ $item->gedung ?? '-' }}</td>
                            <td>
                                <div class="d-flex gap-2 justify-content-center">
                                    @if($role == 'admin')
                                        <a href="{{ route('ruangan.edit', $item->id) }}" class="btn-edit-row">
                                            <i class="bi bi-pencil-fill"></i> Edit
                                        </a>
                                        
                                        <form action="{{ route('ruangan.destroy', $item->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Hapus ruangan {{ $item->nama }}?')">
                                            @csrf
                                            @method('DELETE')
...
<script>
    ...
    document.getElementById('searchInput').addEventListener('keyup', function () {
        ...
        const rows = document.querySelectorAll('#dataTable tbody tr:not(#noMatchRow)');
