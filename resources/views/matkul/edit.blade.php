...
<body>
<div class="card-form">
    <h3>✏️ Edit Mata Kuliah</h3>
    <form action="{{ route('matkul.update', $matkul->id) }}" method="POST">
        @csrf
        <div class="row">
            <div class="col-md-6 mb-3"><label>Kode MK</label><input type="text" name="kode_mk" class="form-control" value="{{ $matkul->kode_mk }}" required></div>
            <div class="col-md-6 mb-3"><label>Nama Mata Kuliah</label><input type="text" name="nama" class="form-control" value="{{ $matkul->nama }}" required></div>
            <div class="col-md-4 mb-3"><label>SKS</label><input type="number" name="sks" class="form-control" value="{{ $matkul->sks }}" required></div>
            <div class="col-md-4 mb-3"><label>Semester</label><input type="number" name="semester" class="form-control" value="{{ $matkul->semester }}" required></div>
            <div class="col-md-4 mb-3"><label>Prodi</label><input type="text" name="prodi" class="form-control" value="{{ $matkul->prodi }}" required></div>
        </div>
