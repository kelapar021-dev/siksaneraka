...
<head>
    ...
    <style>
        /* ══════════════════════════════════════════
            DESIGN TOKENS — Biru Putih Academic
        ══════════════════════════════════════════ */
        :root {
            --blue-900 : #0d2e6e;
            --blue-800 : #1a3f8f;
...
<aside class="sidebar" id="sidebar">
    ...
    <a href="{{ route('matkul.index') }}"   class="nav-link-sb active"><i class="bi bi-book-fill"></i> Mata Kuliah</a>
    ...
    @endif
    {{-- BERHASIL DITAMBAHKAN SESUAI HALAMAN DOSEN --}}
...
<div class="main-wrap">
    ...
    <div class="topbar">
        <div class="topbar-left">
            ...
            <div>
                <p class="topbar-title"><i class="bi bi-book-fill me-1" style="color:var(--blue-600);"></i>Mata Kuliah</p>
                <p class="topbar-sub">Kelola seluruh data mata kuliah terdaftar</p>
            </div>
        </div>
    ...
    <div class="page-content">
        <div class="table-card">
            ...
            <div class="info-note info-blue">
                ...
                Sebagai <strong>Mahasiswa</strong>, Anda hanya dapat melihat daftar mata kuliah.
            </div>
            @endif

            {{-- Header --}}
            <div class="table-card-header" style="margin-top: {{ $role == 'mahasiswa' ? '0' : '16px' }};">
                <div class="d-flex align-items-center gap-3 flex-wrap">
                    <h5 class="table-card-title">
                        <i class="bi bi-book-fill me-1" style="color:var(--blue-600);"></i>Data Mata Kuliah
                    </h5>
                    <div class="role-info-bar">
                        ...
                        @elseif($role=='dosen') Kelola Mata Kuliah (CRUD)
                        @else Hanya Lihat
                        @endif
                    </div>
                </div>
                <div class="d-flex gap-2 align-items-center flex-wrap">
                    <input type="text" class="search-inp" id="searchInput" placeholder="🔍 Cari mata kuliah...">
                    @if(in_array($role, ['admin', 'dosen']))
                    <a href="{{ route('matkul.create') }}" class="btn-tambah">
                ...
                <table id="dataTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><span class="badge-kode">{{ $item->kode_mk }}</span></td>
                            ...
                            <td>
                                <div class="d-flex gap-2 justify-content-center">
                                    @if(in_array($role, ['admin', 'dosen']))
                                        <a href="{{ route('matkul.edit', $item->id) }}" class="btn-edit-row">
                                            <i class="bi bi-pencil-fill"></i> Edit
                                        </a>
                                        <a href="{{ route('matkul.destroy', $item->id) }}" class="btn-del-row"
