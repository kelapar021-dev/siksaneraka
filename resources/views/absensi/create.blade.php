...
<html lang="en">
<head>
    <meta charset="UTF-8"><title>Input Absensi</title>
    ...
    <style>
        *{font-family:'Poppins',sans-serif;}
        ...
        .btn-simpan{background:linear-gradient(135deg,#43e97b,#38f9d7);border:none;color:#111;font-weight:700;padding:12px 30px;border-radius:12px;}
    ...
    <form action="{{ route('absensi.store') }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <select name="pertemuan_id" class="form-select" required>
                ...
                <option value="{{ $p->id }}">{{ $p->nama_matkul }} - Pertemuan ke-{{ $p->pertemuan_ke }} ({{ $p->tanggal }})</option>
                @endforeach
            </select>
        </div>
        <div class="row">
